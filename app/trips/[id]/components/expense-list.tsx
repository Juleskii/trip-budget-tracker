      ...
      {expenses.map((expense) => {
        ...
        return (
          <Link
            ...
            className="block py-4 hover:bg-gray-50 active:bg-gray-100 -mx-6 px-6 transition-all duration-150 cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset rounded-lg"
          >
            <div className="flex items-center justify-between gap-4">
              <div className="flex-1 min-w-0">
                ...
                {expense.note && (
                  <p className="text-sm text-gray-700 truncate mt-1 pl-1">
                    {expense.note}
                  </p>
                )}
              </div>
